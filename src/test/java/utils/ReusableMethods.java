...
public class ReusableMethods {
    ...
    public static void koordinatTiklama(int xDegiskeni,int yDegiskeni,int bekleme) throws InterruptedException, MalformedURLException {
        TouchAction action=new TouchAction<>(Driver.getAndroidDriver());
        action.press(PointOption.point(xDegiskeni,yDegiskeni)).release().perform();
        Thread.sleep(bekleme);
    }

    public static void screenScroll(int xPress,int yPress,int wait,int moveX,int moveY) throws MalformedURLException {
        TouchAction action=new TouchAction<>(Driver.getAndroidDriver());
    ...
    public static void screenScrollDown(int wait) throws MalformedURLException {
        TouchAction action=new TouchAction<>(Driver.getAndroidDriver());
    ...
    public static void screenScrollUp(int wait) throws MalformedURLException {
        TouchAction action=new TouchAction<>(Driver.getAndroidDriver());
    ...
    // 1052,1016 31,1016
    public static void screenScrollRight(int wait) throws MalformedURLException {
        TouchAction action = new TouchAction<>(Driver.getAndroidDriver());
    ...
    public static void screenScrollLeft(int wait) throws MalformedURLException {
        TouchAction action = new TouchAction<>(Driver.getAndroidDriver());
